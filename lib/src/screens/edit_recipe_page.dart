...
class EditRecipePage extends StatefulWidget {
  ...
  EditRecipePage(this.recipe, this.context, {Key? key})
      : super(key: key);
...
class EditRecipeState extends State<EditRecipePage> {
                      ...
                      child: Padding(
                        ...
                        child: ListView(
                          children: [
                            ...
                            TextFormField(
                              initialValue: widget.recipe.images,
                              decoration: const InputDecoration(
  ...
  _save(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      Recipe recipe = Recipe(widget.recipe.id, name, image, description);

      final editedRecipe = await RecipeApi.editRecipe(recipe);
      ...
      if (editedRecipe) {
        ...
        _showSnackBar("The recipe was not edited correctly");
      }
